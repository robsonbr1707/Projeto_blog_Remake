<script setup>
    ...
    function destroy(id) {
        if (confirm("Deseja Excluir o Registro?")) {
            form.delete(route('records.destroy', id));
        }
    }
</script>
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div className="flex items-center justify-between mb-6">
                            <Link
                                ...
                                :href="route('records.create', {post_id: post_id})">
                                Criar Registro
                            </Link>
                            <Link
                        ...
                        <div className="mb-6">
                            <p class="text-center" v-show="records.data.length == 0">Nenhum Registro Encontrado</p>
                        </div>
                        <table className="table-fixed w-full mt-4" v-show="records.data.length >= 1">
                            <thead>
                            ...
                            <tbody>
                                <tr v-for="record in records.data" :key="record.id">
                                    ...
                                    <td className="border px-4">
                                        <a :href="'storage/'+record.image" target="_blank" className="leading-5 font-semibold text-green-800 ">
                                            Ver Imagem
                                        </a>
                                    </td>
